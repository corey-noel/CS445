...
public class PairTester
{
    public static void main(String[] args)
    {
        ...
        System.out.print("Testing the method reverse(): ");
        PairInterface<PairInterface<String,Integer>,Integer> p10_1 = new Pair<PairInterface<String,Integer>,Integer>(p4_1,l4_2);
        PairInterface<PairInterface<String,Integer>,Integer> p10_2 = p4_2.reverse();
        if(!p10_1.equals(p10_2))
        {
            System.out.println("FAIL");
            System.out.println("The reverse order of the pair " + p4_1 + " should be the pair " + p10_1);
            System.out.println("But your method reverse() returned the pair " + p10_2 + ".\n");
        }
        else
        {
            System.out.println("PASS");
